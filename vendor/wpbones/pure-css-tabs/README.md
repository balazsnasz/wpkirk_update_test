...
```php
     ...
     * @param array $array
     */
    BalazsKirkUpdate\PureCSSTabs\PureCSSTabsProvider::tabs(
      'tab-1' => [ 'label' => 'Tab 1', 'content' => 'Hello', 'selected' => true ],
      'tab-2' => [ 'label' => 'Tab 1', 'content' => 'Hello' ],
      ...
    );
...
<div class="wpbones-tabs">
  ...
  <?php BalazsKirkUpdate\PureCSSTabs\PureCSSTabsProvider::openTab( 'Tab 1', null, true ) ?>
    <h2>Hello, world! I'm the content of tab-1</h2>
  <?php BalazsKirkUpdate\PureCSSTabs\PureCSSTabsProvider::closeTab ?>
    
  <?php BalazsKirkUpdate\PureCSSTabs\PureCSSTabsProvider::openTab( 'Tab 2' ) ?>
...
> :pushpin:
>
> Remember, in the example above I have used `BalazsKirkUpdate` base namespace. You should replace it with your own namespace.
