...
namespace BalazsKirkUpdate\WPBones\Foundation;

use Closure;
use BalazsKirkUpdate\WPBones\Container\Container;
use BalazsKirkUpdate\WPBones\Contracts\Foundation\Plugin as PluginContract;
use BalazsKirkUpdate\WPBones\Database\WordPressOption;
use BalazsKirkUpdate\WPBones\Foundation\Http\Request;
use BalazsKirkUpdate\WPBones\Foundation\Log\LogServiceProvider;
use BalazsKirkUpdate\WPBones\Routing\AdminMenuProvider;
use BalazsKirkUpdate\WPBones\Routing\AdminRouteProvider;
use BalazsKirkUpdate\WPBones\Routing\API\RestProvider;
use BalazsKirkUpdate\WPBones\Routing\Pages\PageProvider;
use BalazsKirkUpdate\WPBones\Support\Str;
use BalazsKirkUpdate\WPBones\Support\Traits\HasAttributes;
use BalazsKirkUpdate\WPBones\View\View;
...
/**
 * @class   Plugin
 * @package BalazsKirkUpdate\WPBones\Foundation
 *
...
class Plugin extends Container implements PluginContract
{
  ...
  public function boot(): Plugin
  {
     ...
     * Description = "BalazsKirkUpdate is a WP Bones boilperate plugin"
     * DomainPath = "localization"
     * Name = "BalazsKirkUpdate"
     * Network = false
     * PluginURI = "http://undolog.com"
     * TextDomain = "balazs-kirk-update-test"
     * Title = "BalazsKirkUpdate"
     * Version = "1.0.0"
     */
   ...
   *
   * @return \BalazsKirkUpdate\WPBones\View\View
   */
  ...
  public function upgrader_post_install($response, $hook_extra, $result)
  {
    ...
    //if ($hook_extra['type'] == 'plugin') {
      ...
      if (/*$hook_extra['action'] == 'update' && */isset($hook_extra['plugin'])) {
        ...
        print_r(plugin_basename($this->file));
  ...
  public function getCallableHook($routes)
  {
    ...
    if (isset($controller) && isset($method)) {
      return function () use ($controller, $method) {
        $className = "BalazsKirkUpdate\\Http\\Controllers\\{$controller}";
