...
namespace BalazsKirkUpdate\WPBones\Database;

use InvalidArgumentException;
use BalazsKirkUpdate\WPBones\Database\Support\Collection;
use BalazsKirkUpdate\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \BalazsKirkUpdate\WPBones\Database\Support\Collection
   */
  private $collection = [];
   ...
   * @return \BalazsKirkUpdate\WPBones\Database\QueryBuilder
   */
